...
import { Random, RandomStream } from "../../src"
...
export const mWellTypedStream =
    <T> (rng: Random<T>) => macro("well-typed-stream", (t) => {
...
export const mWellTyped =
    <T> (rng: Random<T>) => macro("sell-typed", (t) => {
...
export const mCopyOnWrite =
    <T> (rng: Random<T>) => macro("copy-on-write", (t, s: Sample) => {
...
export const mFromPlain =
    <T> (rng: Random<T>) => macro("from-plain", (t) => {
