 ...
 */
interface ReadonlyTypeableArray <E> {
...
// Logic
     ...
     */
    every (pred: (this: void, item: E, index: number, array: ReadonlyTypeableArray<E>) => boolean, target?: undefined): boolean
    every <Z> (pred: (this: Z, item: E, index: number, array: ReadonlyTypeableArray<E>) => boolean, target: Z): boolean
     ...
     */
    some (pred: (this: void, item: E, i: number, array: ReadonlyTypeableArray<E>) => boolean, target?: undefined): boolean
    some <Z> (pred: (this: Z, item: E, i: number, array: ReadonlyTypeableArray<E>) => boolean, target: Z): boolean
...
// Loop
     ...
     */
    forEach (consumer: (this: void, item: E, index: number, array: ReadonlyTypeableArray<E>) => void, target?: undefined): void
    forEach <Z> (consumer: (this: Z, item: E, index: number, array: ReadonlyTypeableArray<E>) => void, target: Z): void
...
// Searching
     ...
     */
    find (pred:
        (this: void, item: E, index: number, array: ReadonlyTypeableArray<E>) => boolean,
        target?: undefined): E | undefined
    find <Z> (pred: (this: Z, item: E, index: number, array: ReadonlyTypeableArray<E>) => boolean, target: Z): E | undefined
     ...
     */
    findIndex (pred: (this: void, item: E) => boolean, target?: undefined): number
...
// Transformation and filtering
     ...
     */
    filter (pred: (this: void, item: E, i: number, array: ReadonlyTypeableArray<E>) => boolean, target?: undefined): TypeableArray<E>
    filter <Z> (pred: (this: Z, item: E, i: number, array: ReadonlyTypeableArray<E>) => boolean, target: Z): TypeableArray<E>
     ...
     */
    map <U> (producer: (this: void, item: E, i: number, array: ReadonlyTypeableArray<E>) => U, target?: undefined): TypeableArray<U>
    map <U, Z> (producer: (this: Z, item: E, i: number, array: ReadonlyTypeableArray<E>) => U, target: Z): TypeableArray<U>
     ...
     */
    reduce (reducer: (aPrev: E, item: E, i: number, array: ReadonlyTypeableArray<E>) => E, initial?: E): E
     ...
     * @return Result of the reduction of the entire array.
     */
    reduce <U> (reducer: (aPrev: U, item: E, i: number, array: ReadonlyTypeableArray<E>) => U, initial: U): U
     ...
     */
    reduceRight (reducer: (aPrev: E, item: E, i: number, array: ReadonlyTypeableArray<E>) => E, initial?: E): E
     ...
     * @return Result of the backwards reduction of the entire array.
     */
    reduceRight <U> (reducer: (aPrev: U, item: E, i: number, array: ReadonlyTypeableArray<E>) => U, initial: U): U
 ...
 */
interface TypeableArray <E> extends ReadonlyTypeableArray<E> {
 ...
 */
interface TypeableArrayFactory <E, T extends TypeableArray<E>> {
     ...
     */
    from <U> (ref: Iterable<U>, converter: (this: void, v: U, k: number) => E, atarget?: undefined): T
    from <U, Z> (ref: Iterable<U>, converter: (this: Z, v: U, k: number) => E, atarget: Z): T
 ...
 */
type TypeableArrayConstructor <E> = TypeableArrayFactory<E, TypeableArray<E>>
