...
export function arayFrom <T extends TypeableArray<number>> (
        ...
        itemGuard: (y: unknown) => y is number): T {

    if ((Array.isArray(x) || x instanceof Uint8ClampedArray ||
        x instanceof Uint8Array ||  x instanceof Uint16Array ||
        x instanceof Uint32Array || x instanceof Int8Array ||
        x instanceof Int16Array || x instanceof Int32Array ||
