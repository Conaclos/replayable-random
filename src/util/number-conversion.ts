...
/** @internal */
export const asFract32 = (prand: u32 | i32): fract32 => prand * SHIFT_RIGHT_32

/** @internal */
export const asI32 = (prand: u32): i32 => prand | 0

/** @internal */
export const asU32Between = (
    l: u32,
    exclusiveU: u32,
    prand: fract32 | fract53
): u32 => (((prand * (exclusiveU - l)) >>> 0) + l) >>> 0

/** @internal */
export const asI32Between = (
    l: i32,
    exclusiveU: i32,
    prand: fract32 | fract53
): i32 => (((prand * (exclusiveU - l)) >>> 0) + l) | 0
